...
const en: Messages = {
  ...
  "individual.focus.plan": "Plan: {name}",
  "individual.focus.planNone": "Plan: none",
  "individual.focus.tasks": "Tasks:",
  "individual.focus.tasksNone": "Tasks: none",
  "individual.focus.otherGoals": "Other goals: {names}",
  "individual.want.created": "want: {name}",
  "individual.design.created": "plan for {name}",
  "individual.todo.created": "todo: {name}",
...
const zh: Messages = {
  ...
  "individual.focus.plan": "计划: {name}",
  "individual.focus.planNone": "计划: 无",
  "individual.focus.tasks": "任务:",
  "individual.focus.tasksNone": "任务: 无",
  "individual.focus.otherGoals": "其他目标: {names}",
  "individual.want.created": "目标: {name}",
  "individual.design.created": "{name} 的计划",
  "individual.todo.created": "待办: {name}",
